...
const Navbar = () => {
  ...
  return (
    <div className='flex justify-between items-center h-24 max-w-[1240px] mx-auto px-4 text-white'>
      <h1 className='w-full text-3xl font-bold text-[#00df98]'>
        BAHrney.
      </h1>
      ...
      <div className={nav ? 'fixed left-0 top-0 w-[50%] h-[100%] border-r border-r-gray-200 bg-[#000300] ease-in-out duration-500' : 'fixed left-[-100%]'}>
        <h1 className='w-full text-3xl font-bold text-[#00df9a] m-4'>BAHrney.</h1>
